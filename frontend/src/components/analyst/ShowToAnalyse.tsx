      ...
      <div className='container'>
        ...
        <table className='table table-hover'>
          ...
          <tbody>
            {books.length === 0 ? (
              <tr>
                <td colSpan={4} className='text-center'>There is no book record!</td>
              </tr>
            ) : (
              books.map((book) => (
                <tr key={book._id}>
                  ...
                  <td>
                    <Link href={`/analyse-book/${book._id}`} className='btn btn-outline-info btn-sm' style={{backgroundColor:'dodgerblue', padding:'3px'}}>
                      Add analysis
                    </Link>
                  </td>
                </tr>
